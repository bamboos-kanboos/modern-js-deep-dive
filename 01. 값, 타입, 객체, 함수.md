...
3. 함수 (Function)
    ...
    - 호이스팅
        ...
        - 변수 호이스팅 (Variable Hoisting)
            - `var`, `let`, `const`와 **함수 표현식**(`const foo = () => {}`과 같이 함수를 변수에 할당하는 것)에 적용
            ...
            - 함수 선언문과 함수 표현식의 호이스팅 결과 차이

                ![호이스팅 코드.png](images/01-16.png)
                  - sayHello: 함수 선언문. 호이스팅이 되어 선언문 위에서 실행이 가능
                  - hello: 함수 표현식. 변수 호이스팅만 되고 값 초기화(값 할당)는 되지 않아 함수를 표현식 위에서 실행이 불가

                ![실행결과.png](images/01-17.png)
